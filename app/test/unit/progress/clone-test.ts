...
describe('CloneProgressParser', () => {
  describe('#parse', () => {
    ...
    it('understand relative weights', () => {
      const compressing = parser.parse('remote: Compressing object: 45% (10/22)')
      ...
      expect(resolving.percent).to.be.closeTo(0.7 + (18063 / 20263 * 0.6), 0.01)
