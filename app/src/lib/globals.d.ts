...
/**
 * Request an idle callback. See https://developer.mozzila.org/en-US/docs/Web/API/Window/requestIdleCallback
 * for more information.
 */
declare function requestIdleCallack(fn: () => void, options?: { timeout: number }): number
