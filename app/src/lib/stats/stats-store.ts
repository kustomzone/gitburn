...
const StatsEndpoint = 'http://central.siberianmh.com/api/usage/gitburn'

/** The URL to the stats samples page. */
export const SamplesURL = 'https://desktop.gitburn.com/usage-data/'
...
export class StatsStore {
  ...
  private categorizedRepositoryCounts(repositories: ReadonlyArray<Repository>) {
    return {
      repositoryCounts: repositories.length,
