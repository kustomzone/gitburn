...
export class AppWindow {
  ...
  public constructor() {
    ...
    const windowOptions: Electron.BrowserWindowOptions = {
      ...
      webPreferences: {
        ...
        // Enable, amoung other things, the ResizeObserver
  ...
  public sendException(error: Error) {
    // `Error` can't be JSONified so it doensn't transport nicely over IPC. So
  ...
  /** Report an auto updater to the renderer. */
